...
type PlatformMeta = {
  label: string;
  /** Build the public profile URL from a raw handle (without leading "@"). */
  url: (handle: string) => string;
  /** Single-path brand icon, viewBox 0 0 24 24, tinted via currentColor. */
...
/** Ordered list so icons render consistently regardless of object key order. */
